...
const Home = () => {
    ...
    const filteredWines = wines.filter(
        (w) =>
            ...
            w.country.toLowerCase().includes(countrySelected.toLowerCase()) &&
            w.grapes.toLowerCase().includes(grapesSelected.toLowerCase())
    );
    ...
    return (
        <div>
            ...
            <div className="lobby-container">
                ...
                {filteredWines.length === 0 && <h3>Aucun résultat</h3>}
                        ...
                        <div className="wine-list">
                            <div className="wine-card">
                                ...
                                <div className="container">
                                    ...
                                    <img
                                        src={`assets/images/${wine.picture}`}
                                        alt="Photo bouteille"
                                    />
                                </div>
                            </div>
